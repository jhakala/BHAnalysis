...
config.General.requestName = 'BHnTuples_2015DpmptRecoV4_oct29'
config.General.workArea = 'crab_jobs_2015DpmptRecoV4_oct29'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'pmptRecoV4_tuples_2015D_v2.py'
...
config.Data.publishDataName = 'BHnTuples_2015DpmptRecoV4_oct29'
