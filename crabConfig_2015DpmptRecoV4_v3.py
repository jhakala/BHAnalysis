...
config.General.requestName = 'BHnTuples_2015DpmptRecoV4_Nov19'
config.General.workArea = 'crab_jobs_2015DpmptRecoV4_Nov19'
...
config.Data.outputDatasetTag = 'BHnTuples_2015DpmptRecoV4_Nov19'
