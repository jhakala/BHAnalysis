...
config.General.requestName = 'BHnTuples_2015C_76X_May2'
config.General.workArea = 'crab_jobs_2015C_76X_May2'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'bh76cfg_Run2015C_25ns-2May2016.py'
...
config.Data.outputDatasetTag = 'BHnTuples_2015C_76x_May2'
