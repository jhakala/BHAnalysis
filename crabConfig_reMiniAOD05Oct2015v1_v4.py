...
config.General.requestName = 'BHnTuples_2015DreMiniAOD05Oct2015v1_Nov27'
config.General.workArea = 'crab_jobs_2015DreMiniAOD05Oct2015v1_Nov27'
config.General.transferOutputs = True
config.General.transferLogs = True

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'reMiniAOD05Oct2015v1-tuples_2015D_v3.py'
...
config.Data.outputDatasetTag = 'BHnTuples_2015DreMiniAOD05Oct2015v1_Nov27'
