...
config.General.requestName = 'BHnTuples_2015DpmptRecoV4'
config.General.workArea = 'crab_jobs_2015DpmptRecoV4'
...
config.Data.publishDataName = 'BHnTuples_2015DpmptRecoV4'
